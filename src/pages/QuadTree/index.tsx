...
export default function QuadTreeView() {
  ...
  const ref_div_fps = useRef<HTMLSpanElement>(null);
  const ref_div_count = useRef<HTMLSpanElement>(null);
  ...
  return (
    <div>
      <div style={{ display: "flex", gap: 5, alignItems: 'center' }}>
        <span style={{ display: "flex" }}>fps: <span ref={ref_div_fps} /></span>
        <span style={{ display: "flex" }}>count: <span ref={ref_div_count} /></span>
        <span style={{ display: "flex" }}>capacity:
          <input
        ...
        <span style={{ display: "flex" }}>add:
          <input ref={ref_input_num_of_add} />
          <button
            onClick={() => {
